...
SOFT_REF_TYPECODES = ['SAR_SX_SLC', 'SAR_SX_SGF', 'SAR_SX_SGX', 'SAR_SX_SSG', 'SAR_SX_SPG', 'SAR_WX_SLC', 'SAR_WX_SGF',
                      'SAR_WX_SGX', 'SAR_WX_SSG', 'SAR_WX_SPG', 'SAR_FX_SLC', 'SAR_FX_SGF', 'SAR_FX_SGX', 'SAR_FX_SSG',
                      'SAR_FX_SPG', 'SAR_FW_SLC', 'SAR_FW_SGF', 'SAR_FW_SGX', 'SAR_FW_SSG', 'SAR_FW_SPG', 'SAR_MF_SLC',
                      'SAR_MF_SGF', 'SAR_MF_SGX', 'SAR_MF_SSG', 'SAR_MF_SPG', 'SAR_MW_SLC', 'SAR_MW_SGF', 'SAR_MW_SGX',
                      'SAR_MW_SSG', 'SAR_MW_SPG', 'SAR_EF_SLC', 'SAR_EF_SGF', 'SAR_EF_SGX', 'SAR_EF_SSG', 'SAR_EF_SPG',
                      'SAR_UF_SLC', 'SAR_UF_SGF', 'SAR_UF_SGX', 'SAR_UF_SSG', 'SAR_UF_SPG', 'SAR_UW_SLC', 'SAR_UW_SGF',
                      'SAR_UW_SGX', 'SAR_UW_SSG', 'SAR_UW_SPG', 'SAR_EH_SLC', 'SAR_EH_SGF', 'SAR_EH_SGX', 'SAR_EH_SSG',
                      'SAR_EH_SPG', 'SAR_EL_SLC', 'SAR_EL_SGF', 'SAR_EL_SGX', 'SAR_EL_SSG', 'SAR_EL_SPG', 'SAR_SQ_SLC',
                      'SAR_SQ_SGX', 'SAR_SQ_SSG', 'SAR_SQ_SPG', 'SAR_QS_SLC', 'SAR_QS_SGX', 'SAR_QS_SSG', 'SAR_QS_SPG',
                      'SAR_FQ_SLC', 'SAR_FQ_SGX', 'SAR_FQ_SSG', 'SAR_FQ_SPG', 'SAR_QF_SLC', 'SAR_QF_SGX', 'SAR_QF_SSG',
                      'SAR_QF_SPG', 'SAR_SN_SCN', 'SAR_SN_SCF', 'SAR_SN_SCS', 'SAR_SW_SCW', 'SAR_SW_SCF', 'SAR_SW_SCS',
                      'SAR_SL_SLC', 'SAR_SL_SGF', 'SAR_SL_SGX', 'SAR_SL_SSG', 'SAR_SL_SPG']
...
SOFT_BOUNDING_BOX_TYPECODES = ['SAR_SX_SSG', 'SAR_SX_SPG', 'SAR_WX_SSG', 'SAR_WX_SPG', 'SAR_FX_SSG', 'SAR_FX_SPG',
                               'SAR_FW_SSG', 'SAR_FW_SPG', 'SAR_MF_SSG', 'SAR_MF_SPG', 'SAR_MW_SSG', 'SAR_MW_SPG',
                               'SAR_EF_SSG', 'SAR_EF_SPG', 'SAR_UF_SSG', 'SAR_UF_SPG', 'SAR_UW_SSG', 'SAR_UW_SPG',
                               'SAR_EH_SSG', 'SAR_EH_SPG', 'SAR_EL_SSG', 'SAR_EL_SPG', 'SAR_SQ_SSG', 'SAR_SQ_SPG',
                               'SAR_QS_SSG', 'SAR_QS_SPG', 'SAR_FQ_SSG', 'SAR_FQ_SPG', 'SAR_QF_SSG', 'SAR_QF_SPG',
                               'SAR_SL_SSG', 'SAR_SL_SPG']
