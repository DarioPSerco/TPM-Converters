...
class SilenceObject:
    ...
    def __init__(self, stdout, stderr, mode='w'):
        self.outobjects = stdout, stderr
        self.mode = mode
    ...
    def __enter__(self):
        ...
        null_streams = self.outobjects
        self.null_fds = null_fds = null_streams  # [s.fileno() for s in null_streams]
