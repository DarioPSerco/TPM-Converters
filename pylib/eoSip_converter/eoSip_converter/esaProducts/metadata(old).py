...
class Metadata(Base_Metadata):
    #
    METADATA_FIELDS = [METADATA_CLOUD_COVERAGE, METADATA_GENERATION_TIME, METADATA_PRODUCTNAME, METADATA_PRODUCT_SIZE,
                       METADATA_PATH,
                       # for naming conventions; in order to have '#' when no metadata set
                       METADATA_START_DATE, METADATA_STOP_DATE, METADATA_START_TIME, METADATA_STOP_TIME,
                       METADATA_DURATION, METADATA_PROCESSING_STAGE_FLAG, METADATA_PROCESSING_CENTER,
                       METADATA_TYPECODE, METADATA_PLATFORM, METADATA_PLATFORM_ID, METADATA_FILECLASS,
                       METADATA_FOOTPRINT, METADATA_ORBIT, METADATA_TRACK, METADATA_FRAME, METADATA_SIP_VERSION,
                       #
                       METADATA_URL, METADATA_PROCESSING_TIME, METADATA_DATASET_NAME, METADATA_SENSOR_NAME,
                       METADATA_SENSOR_CODE, METADATA_DATA_FILE_PATH, METADATA_DATASET_PRODUCTION_DATE,
                       METADATA_INSTRUMENT_INCIDENCE_ANGLE, METADATA_VIEWING_ANGLE,
                       METADATA_SUN_AZIMUTH, METADATA_SUN_ELEVATION, METADATA_REFERENCE_SYSTEM_IDENTIFIER,
