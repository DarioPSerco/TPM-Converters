...
METADATA_COMPLETION_TIME_FROM_ASCENDING_NODE = (
    "METADATA_COMPLETION_TIME_FROM_ASCENDING_NODE"
)
...
METADATA_INSTRUMENT_ACROSS_TRACK_INCIDENCE_ANGLE = (
    "METADATA_INSTRUMENT_ACROSS_TRACK_INCIDENCE_ANGLE"
)
METADATA_INSTRUMENT_ALONG_TRACK_INCIDENCE_ANGLE = (
    "METADATA_INSTRUMENT_ALONG_TRACK_INCIDENCE_ANGLE"
)
...
METADATA_QUALITY_DEGRADATION_QUOTATION_MODE = (
    "METADATA_QUALITY_DEGRADATION_QUOTATION_MODE"
)
...
METADATA_CODESPACE_SENSOR_OPERATIONAL_MODE = (
    "METADATA_CODESPACE_SENSOR_OPERATIONAL_MODE"
)
...
METADATA_SIP_VERSION = (
    "METADATA_SIP_VERSION"  # is in the SIP filename, the v<VVVV> part
)
METADATA_PRODUCT_VERSION = (
    "METADATA_PRODUCT_VERSION"  # is in the SIP filename, the <vvvv> part
)
...
METADATA_CODESPACE_WRS_LONGITUDE_GRID_NORMALISED = (
    "METADATA_CODESPACE_WRS_LONGITUDE_GRID_NORMALISED"
)
METADATA_WRS_LATITUDE_GRID_NORMALISED = "METADATA_WRS_LATITUDE_GRID_NORMALISED"
METADATA_CODESPACE_WRS_LATITUDE_GRID_NORMALISED = (
    "METADATA_CODESPACE_WRS_LATITUDE_GRID_NORMALISED"
)
...
METADATA_CODESPACE_WRS_LONGITUDE_DEG_NORMALISED = (
    "METADATA_CODESPACE_WRS_LONGITUDE_DEG_NORMALISED"
)
METADATA_WRS_LATITUDE_DEG_NORMALISED = "METADATA_WRS_LATITUDE_DEG_NORMALISED"
METADATA_CODESPACE_WRS_LATITUDE_DEG_NORMALISED = (
    "METADATA_CODESPACE_WRS_LATITUDE_DEG_NORMALISED"
)
...
class Metadata(Base_Metadata):
    #
    METADATA_FIELDS = [
        METADATA_CLOUD_COVERAGE,
        METADATA_GENERATION_TIME,
        METADATA_PRODUCTNAME,
        METADATA_PRODUCT_SIZE,
        METADATA_PATH,
        ...
        METADATA_STOP_TIME,
        METADATA_DURATION,
        METADATA_PROCESSING_STAGE_FLAG,
        ...
        METADATA_SENSOR_NAME,
        METADATA_SENSOR_CODE,
        METADATA_DATA_FILE_PATH,
        METADATA_DATASET_PRODUCTION_DATE,
        METADATA_INSTRUMENT_INCIDENCE_ANGLE,
        METADATA_VIEWING_ANGLE,
        METADATA_SUN_AZIMUTH,
        METADATA_SUN_ELEVATION,
        METADATA_REFERENCE_SYSTEM_IDENTIFIER,
