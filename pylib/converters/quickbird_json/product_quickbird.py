...
from eoSip_converter.esaProducts import browse_metadata, formatUtils, metadata, product_EOSIP, verifier
...
class Product_Quickbird(Product_Directory):
    ...
    def refineMetadata(self, processInfo):
        ...
        if tmp != 'QB02':
            raise Exception("Invalid source product, not QB02 but: '%s'" % tmp)
