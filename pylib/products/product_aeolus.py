...
class Product_Aeolus(Product_Directory):
    IMAGERY_NAME = '.DBL'
    METADATA_NAME = '.HDR'
    EXTRACTED_PATH = None
    metadata_data = None
    ...
    xmlMapping = {
        metadata.METADATA_START_DATE: 'Variable_Header/Main_Product_Header/Sensing_Start',
    ...
    ADV_ORDER = [
        'ADV_minRollAngle', 'ADV_maxRollAngle', 'ADV_minPitchAngle',
        'ADV_maxPitchAngle', 'ADV_minYawAngle', 'ADV_maxYawAngle'
    ]
    ...
    def __init__(self, path, hdrPath):
        ...
        print(" init class Product_Aeolus: path=%s hdrPath=%s" % (self.path, self.hdrPath))
