...
from .product_netCDF import Product_netCDF
...
class Product_NetCDF_Reaper(Product_netCDF):
    ...
    def refineMetadata(self):
        ...
        self.metadata.setMetadataPair(metadata.METADATA_TRACK,
                                      "%s" % self.metadata.getMetadataValue(metadata.METADATA_RELATIVE_ORBIT))
