...
WorldView product, emit the JSON manifest, assert it validates against
schema/worldview.schema.json.
...
def test_emitted_json_validates_against_schema(tmp_path):
    ...
    # validates against the WorldView JSON schema (raises on failure)
