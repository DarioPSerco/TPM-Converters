"""Pytest bootstrap for worldview_json tests.

Puts the converters root and the canonical xml_nodes version (v200) on sys.path
so the test runs standalone:  pytest pylib/converters/worldview_json/test
...
_xml_nodes_v200 = _here.parents[3] / "xml_nodes" / "v200"   # pylib/xml_nodes/v200
