...
from eoSip_converter.esaProducts import product_EOSIP, product_quickbird
...
VERSION = "QuickBird converter V:1.1.0"
SIP_REF_NAME = "QB2_OPER_BGI_PAN_MP_20100527T231608_N13-756_W100-000_0001_v0010.SIP.ZIP"
EO_REF_NAME = "QB2_OPER_BGI_PAN_MP_20100527T231608_N13-756_W100-000_0001"


#
#
#
class ingester_quickbird(ingester.Ingester):
    ...
    def createSourceProduct(self, processInfo):
        ...
        product = product_quickbird.Product_Quickbird(processInfo.srcPath)
...
if __name__ == "__main__":
    try:
        if len(sys.argv) > 1:
            ...
            print("Quickbird conversion report", file=out)
            print(report, file=out)
            print("### End of report", file=out)
            reportName = "Quickbird_conversion_report.txt"
