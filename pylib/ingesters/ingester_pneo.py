...
from eoSip_converter.esaProducts import product_EOSIP, product_pneo
...
VERSION = "PNEO converter V:1.1.1"
REF_NAME = 'PLN_OPER_NEO_P_S_2__20210503T104900_N41-376_E002-153_01_v0101.SIP.ZIP'
...
class ingester_pneo(ingester.Ingester):
    ...
    def buildEoNames(self, processInfo, namingConvention=None):
        ...
        if processInfo.destProduct.metadata.getMetadataValue(metadata.METADATA_PLATFORM_ID) != 'N':
            ...
            processInfo.destProduct.sipProductName = sipProductName
            processInfo.destProduct.sipPackageName = sipPackageName
            ...
            processInfo.destProduct.metadata.setMetadataPair(metadata.METADATA_PACKAGENAME, sipProductName)
            ...
            processInfo.destProduct.metadata.setMetadataPair(metadata.METADATA_FULL_PACKAGENAME, sipPackageName)
