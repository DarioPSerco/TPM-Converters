...
class eop_product(SipMessageBuilder):
    ...
    REPRESENTATION = [
        ...
        "<eop:timeliness codeSpace=\"@codeSpace_timeliness@\">@timeliness@</eop:timeliness>",
        "</eop:ProductInformation>"]

    OPTIONAL = ["<eop:timeliness codeSpace=\"@codeSpace_timeliness@\">@timeliness@</eop:timeliness>"]
