...
class Vec3d(object):
    ...
    def get_angle_between(self, other):
        ...
        r = v1.dot(v2)
        # print "get_angle_between:%f" % r
        if (1.0 - r) <= 0.0001:
            # print "get_angle_between:r is 1"
            return 0
        else:
            # print "get_angle_between:r is not 1"
...
if __name__ == "__main__":
    ...
    class UnitTestVec3d(unittest.TestCase):
        ...
        def testLength(self):
            ...
            # print "assert_(v.length == 1):%s" % (v.length)
            # self.assert_(v.length == 1.0)
            self.assertAlmostEqual(v.length, 1.0)
            v.length = 9
            # print "assert_(v == Vec3d(1,4,8)):%s" % (v)
